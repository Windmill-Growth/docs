...
<Steps>
  ...
  <Step title="Request one lead">
    ...
    By default, the API returns leads with an ICP match of at least 50%. Add `minIcpMatchPercent=0` to include qualified engagers with a lower ICP match.
  </Step>
</Steps>
...
- `icp:manage` allows updates to the active ICP and Signal Brief.
